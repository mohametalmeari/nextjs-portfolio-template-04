    ...
    >
      ...
      <div className="flex flex-col items-center z-10">
        <div className="bg-custom-secondary/5 pt-28 pb-8">
          ...
          <p className="text-[1.8rem] font-semibold mb-5 text-white text-center px-5">
            Reach out for a new project or just say hello
          </p>
        </div>
        <form
          onSubmit={handleSubmit}
          className="w-full bg-custom-dark/80 flex flex-col pt-16 px-5"
        >
          <h3 className="uppercase text-white text-sm font-semibold mb-16">
            Send me a message
          </h3>
          <input
            type="text"
        ...
        <div className="w-full bg-custom-dark/80 flex flex-col pt-16 px-5 gap-3">
        ...
        <div className="w-full bg-custom-dark/80 flex justify-center gap-2 pt-16 pb-32">
          <IconLink
            icon={FacebookIcon}
            href={"https://fb.com"}
            color="white"
